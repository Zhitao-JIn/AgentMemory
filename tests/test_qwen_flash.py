"""测试 Qwen 3.5-flash 调用 - 使用 Router 类"""
import sys
import os
import time
...
print("=" * 50)
print("Qwen 3.5-flash API 调用测试 - 使用 Router 类")
print("=" * 50)
...
try:
    ...
    print("调用 agent.chat() - provider='qwen', type='low' (qwen3.5-flash)")
    print()
